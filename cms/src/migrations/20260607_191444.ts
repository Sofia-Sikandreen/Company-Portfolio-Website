...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.execute(sql`DROP TYPE IF EXISTS "enum_services_icon" CASCADE;`);
  
  await db.execute(sql`
   CREATE TYPE "public"."enum_services_icon" AS ENUM('react', 'js', 'node', 'python', 'design', 'laravel', 'wordpress', 'shopify', 'youtube', 'nextjs', 'typescript', 'flutter', 'docker', 'aws');
  CREATE TYPE "public"."enum_pages_blocks_featured_projects_block_projects_tag" AS ENUM('Web App', 'Automation', 'eCommerce', 'Business', 'Mobile App');
  ...
  CREATE TABLE "pages_blocks_featured_projects_block_projects" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  	"tag" "enum_pages_blocks_featured_projects_block_projects_tag",
  	"description" varchar,
  	"image_id" integer
  );
  
  CREATE TABLE "pages_blocks_featured_projects_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar DEFAULT 'Featured Projects',
  	"subheading" varchar,
  	"block_name" varchar
  );
  ...
  ALTER TABLE "pages_blocks_featured_projects_block_projects" ADD CONSTRAINT "pages_blocks_featured_projects_block_projects_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_featured_projects_block_projects" ADD CONSTRAINT "pages_blocks_featured_projects_block_projects_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_featured_projects_block"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_featured_projects_block" ADD CONSTRAINT "pages_blocks_featured_projects_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_featured_projects_block_projects_order_idx" ON "pages_blocks_featured_projects_block_projects" USING btree ("_order");
  CREATE INDEX "pages_blocks_featured_projects_block_projects_parent_id_idx" ON "pages_blocks_featured_projects_block_projects" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_featured_projects_block_projects_image_idx" ON "pages_blocks_featured_projects_block_projects" USING btree ("image_id");
  CREATE INDEX "pages_blocks_featured_projects_block_order_idx" ON "pages_blocks_featured_projects_block" USING btree ("_order");
  CREATE INDEX "pages_blocks_featured_projects_block_parent_id_idx" ON "pages_blocks_featured_projects_block" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_featured_projects_block_path_idx" ON "pages_blocks_featured_projects_block" USING btree ("_path");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_featured_projects_block_projects" CASCADE;
  DROP TABLE "pages_blocks_featured_projects_block" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_featured_projects_block_projects_tag";
