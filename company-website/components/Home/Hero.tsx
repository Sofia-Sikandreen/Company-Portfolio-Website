...
export default function Hero({ data }: { data?: HeroData }) {
  ...
  return (
    <section id="home" ref={heroRef} className="hero" style={{ userSelect: "none", cursor: "default" }}>
      ...
      <div className="hero-container">
        ...
        <div className="animate-on-scroll btn-row">
  ...
  <Link href={btn2Link} className="btn-outline">
    {btn2Text}
      ...
      <style jsx>{`
        .hero { min-height: 100vh; padding-top: 90px; position: relative; overflow-x: hidden; background: var(--bg-main); }
        ...
        .wave-back { fill: var(--tag-bg); 
        opacity: 0.6;
        }

        .wave-front { fill: var(--card-bg);      
        opacity: 1;
        }
