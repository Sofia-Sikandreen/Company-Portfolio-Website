    ...
    <main style={{
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 80 }}>
          <p style={{
            color: '#91a4d7', letterSpacing: "0.3em", fontSize: 15,
          ...
          <p style={{ color: "#9ca3af", maxWidth: 700, margin: "18px auto 0", lineHeight: 1.7 }}>
        ...
        <div style={{
          ...
          {[
            { icon: TrendingUp, value: "50+", label: "Projects Completed", gradient: "from-[#0f727a] to-[#68477c]" },
            { icon: Users, value: "30+", label: "Happy Clients", gradient: "from-[#91a4d7] to-[#68477c]" },
            { icon: CheckCircle, value: "99%", label: "Satisfaction", gradient: "from-[#0f727a] to-[#91a4d7]" },
          ].map((item, i) => (
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{
                ...
                <h3 style={{ color: "#91a4d7", marginBottom: 10 }}>{item.title}</h3>
